%% handin v0.0.4-betab44 - 2018/04/06
%% The LaTeX package handin - version v0.0.4-beta (2018/04/06) build 44
%% #PACKAGE.sty
%% -------------------------------------------------------------------------------------------
...
\title{{handin - manual\\ v0.0.4-beta{\\[-0.5em]\footnotesize(build 44)}}}
