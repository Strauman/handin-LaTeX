...
## Table of contents
* Resources:
  * [Latest version (v0.0.3b42) (.zip)](https://raw.githubusercontent.com/Strauman/Handin-LaTeX-template/master/handin.zip)
...
## Versions
The current latest version available on GitHub is v0.0.3 (2018/04/06) build 42
