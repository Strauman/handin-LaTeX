...
## Table of contents
* Resources:
  * [Latest version (v0.0.4-prerelease)(.zip)](https://raw.githubusercontent.com/Strauman/Handin-LaTeX-template/master/handin.zip)
...
## Versions
The current latest version available on GitHub is v0.0.4-prerelease (2018/04/08) build 45
