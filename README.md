...
## Table of contents
* Resources:
  * [Latest version (v>0.1.2-edge)(.zip)](https://raw.githubusercontent.com/Strauman/Handin-LaTeX-template/master/handin.zip)
...
## Versions
The current latest version available on GitHub is v>0.1.2-edge (2018/04/13) build 50
